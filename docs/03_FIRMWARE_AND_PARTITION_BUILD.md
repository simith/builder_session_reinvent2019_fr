...
The factory provisioning of the ESP32 module involves provisioning it with AWS IoT certificates, keys, Code signing certificate and any other configuration that you would like to provide to the Device.
